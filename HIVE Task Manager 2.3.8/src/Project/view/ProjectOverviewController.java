...
public class ProjectOverviewController {
	...
	public void initialTask() {
		try {
			...
			TaskOverview.getStylesheets().add(getClass().getResource("DarkTheme.css").toExternalForm());
...
//			page.getStylesheets().add(getClass().getResource("DarkTheme.css").toExternalForm());

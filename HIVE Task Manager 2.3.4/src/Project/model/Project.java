...
//	private final IntegerProperty NumTask;
	...
	private final ObjectProperty<LocalDateTime> ProjectCreatedDateTime;
	private final ObjectProperty<LocalDateTime> ProjectLastUpdateDateTime;
...
//		this.NumTask = new SimpleIntegerProperty(0);
    ...
    public LocalDateTime getProjectCreatedDateTime() {
        return ProjectCreatedDateTime.get();
    }
    ...
    public ObjectProperty<LocalDateTime> projectCreatedDateProperty() {
        return ProjectCreatedDateTime;
    }
	
    // LastUpdate
	
    public LocalDateTime getProjectLastUpdateDateTime() {
        return ProjectLastUpdateDateTime.get();
    }

    public void setProjectLastUpdateDateTime(LocalDateTime ProjectLastUpdateDateTime) {
        this.ProjectLastUpdateDateTime.set(ProjectLastUpdateDateTime);
    }
    
    public ObjectProperty<LocalDateTime> ProjectLastUpdateDateTimeProperty() {
        return ProjectLastUpdateDateTime;
    }

...
public class Task {
	...
	public final StringProperty TaskName;
	public final ObjectProperty<LocalDate> TaskDueDate;
	public final StringProperty TaskDescription;
	
	public final ObjectProperty<LocalDateTime> TaskCreatedDateTime;
	public final ObjectProperty<LocalDateTime> TaskLastUpdateDateTime;
	public final ObjectProperty<Project> TaskProject;
	...
	public String getTaskDescriptione() { return TaskDescription.get(); }
    ...
    public LocalDate getTaskDueDate() { return TaskDueDate.get(); }
    ...
    public ObjectProperty<LocalDate> TaskDueDateProperty() { return TaskDueDate; }
    
    public LocalDateTime getTaskCreatedDateTime() { return TaskCreatedDateTime.get(); }
    ...
    public ObjectProperty<LocalDateTime> taskCreatedDateTimeProperty() {  return TaskCreatedDateTime; }
	
    // LastUpdate
	
    public LocalDateTime getTaskLastUpdateDateTime() { return TaskLastUpdateDateTime.get(); }
...
//		this.setTaskLastUpdateDateTime(LocalDateTime.now());
    ...
    public ObjectProperty<LocalDateTime> taskLastUpdateDateTimeProperty() { return TaskLastUpdateDateTime; }
    
    
    public Project  getTaskProjectProject() { return this.TaskProject.get(); }
    ...
    public ObjectProperty<Project> TaskProjectProperty() { return TaskProject; }
	...
	public void setTaskCompletion(boolean completion){ this.TaskComplete = completion; }
	
	public boolean getTaskCompletion(){ return this.TaskComplete; }
